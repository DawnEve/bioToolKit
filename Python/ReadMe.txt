...
1.生信编程直播第一题：人类基因组的外显子区域到底有多长。
http://www.biotrainee.com/thread-3-1-1.html

2.文件 Python3_pieces.txt 记录了Python3常用的代码片段。
便于快速复用。
...
5. 保护眼睛的程序，每45分钟(可调)弹窗一次全屏。/failed
EyeDefender.py  //失败，窗口弹出不明显，有时候根本看不到。




6. 网页运行python代码 /failed
...
7. Louvain 算法，社区发现 community detection
Seurat 4 使用的社区发现算法。
详情记录到其内容中。
