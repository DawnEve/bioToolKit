...
class Louvain:
    ...
    def first_stage(self):
        ...
        while True:
            ...
            iter_times_phaseI+=1;
            print(f"0=> phaseI iter:{iter_times_phaseI} (max:{MAX_PHASE_I})" )
            ...
            for v_vid in visit_sequence:
                ...
                for w_vid in self._G[v_vid].keys():
                    ...
                    if w_cid in cid_Q:
                        ...
                        delta_Q2= -k_v_in2 - k_v**2 + 2*k_v*tot2
                ...
                if len(cid_Q)==0:
                    print("====> len(cid_Q):0")
                    can_stop = True #只有有一个点的社区号调整过，这里就是F，就可以下一轮循环。
                    mod_inc = False
                    break;
